                        ...
                        <div className=" h-25 flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <div
                                    ...
                                    id="mobile-menu"
                                >
                                    <ul className="absolute right-0 top-7 flex flex-col rounded-lg bg-gray-50 mr-7 mb-3 dark:border-gray-700 dark:bg-gray-800 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:text-sm md:font-medium md:dark:bg-cyan-900">
                                        <li>
                                            <a
                                                href="/"
